...
- **Status:** accepted
- **Amended by:** [ADR-0007](0007-amendments-to-adr-0004-append-only-evidence-and-consent-timestamps.md) (audit lock by trigger on every evidence table; `consent_events.at` is `timestamptz`)
- **Date:** 2026-09-09
