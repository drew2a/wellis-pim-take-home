...
// never collide with another. That split is also what makes a repeated transition safe: the only
// writer that can repeat one is a human, and a human entry has no key to collide with
// (ADR-0012 item 1).
