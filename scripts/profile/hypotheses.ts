/**
 * Tests the mapping hypotheses raised by docs/data-profile.md against the whole export and
 * writes docs/data-hypotheses.md. Run with `npm run profile:hypotheses`.
 *
...
writeFileSync(join(ROOT, 'docs', 'data-hypotheses.md'), out.join('\n') + '\n');
console.log(`wrote docs/data-hypotheses.md (${out.length} lines)`);
